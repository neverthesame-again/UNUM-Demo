    ...
    Tester: {
      ...
      tabData: {
        test_suites: {
          ...
          items: [
            { id: "ts1", suite: "Playwright E2E Regression", framework: "Playwright / TS", total: 180, passed: 177, failed: 3, passRate: "99.6%", duration: "8m 12s" },
      ...
      tabData: {
        ...
        agent_resolve: {
          ...
          items: [
            ...
            { id: "arb1", num: "INC009405", subject: "Batch Job Failure — Auto-Restart Required", system: "Batch Job Scheduler", resolution: "Automated Batch Job Restart & Lock Clearance", status: "Action Required", statusType: "warn", isIgnio: true, actionLabel: "Auto Resolve", batchTag: "Batch Job Auto-Restart" },
            { id: "arb2", num: "RITM004120", subject: "Member Enrollment Batch Stalled — Auto-Resume Required", system: "HR Enrollment Batch Service", resolution: "Automated Member Enrollment Batch Resume", status: "Action Required", statusType: "warn", isIgnio: true, actionLabel: "Auto Resolve", batchTag: "Enrollment Batch Resume" },
          ],
        },
        vulnerabilities: {
          title: "AMS Vulnerabilities & Security Findings",
