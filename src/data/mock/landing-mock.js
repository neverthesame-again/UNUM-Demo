    ...
    "Support Engineer": {
      ...
      tabData: {
        ...
        vulnerabilities: {
          ...
          items: [
            { id: "app1", title: "Sales Connect", category: "Application Health", status: "Critical", statusType: "danger", desc: "Click to view health metrics and graphs for Sales Connect." },
            { id: "app2", title: "agent Point", category: "Application Health", status: "Healthy", statusType: "good", desc: "Click to view health metrics and graphs for agent Point." },
            { id: "app3", title: "Sell Point", category: "Application Health", status: "Healthy", statusType: "good", desc: "Click to view health metrics and graphs for Sell Point." },
            { id: "app4", title: "Group Member Shopping", category: "Application Health", status: "Critical", statusType: "danger", desc: "Click to view health metrics and graphs for Group Member Shopping." },
            { id: "app5", title: "PMT-Product Managment", category: "Application Health", status: "Warning", statusType: "warn", desc: "Click to view health metrics and graphs for PMT-Product Managment." },
            { id: "app6", title: "Cars", category: "Application Health", status: "Healthy", statusType: "good", desc: "Click to view health metrics and graphs for Cars." },
            { id: "app7", title: "TeleSales SalesForce", category: "Application Health", status: "Healthy", statusType: "good", desc: "Click to view health metrics and graphs for TeleSales SalesForce." },
            { id: "app8", title: "Agent Mobile App", category: "Application Health", status: "Healthy", statusType: "good", desc: "Click to view health metrics and graphs for Agent Mobile App." },
          ],
        },
      },
      stateOfEnvironment: {
