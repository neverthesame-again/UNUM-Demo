      ...
      tabData: {
        agent_resolve: {
          ...
          items: [
            ...
            { id: "ar3", num: "INC009428", subject: "Deterministic (Data Validation) — EDI 837 Claim Schema Validation Failure", system: "Claims Ingestion Engine", resolution: "Automated EDI X12 Schema Re-alignment", status: "Action Required", statusType: "warn", isDeterministic: true, actionLabel: "Auto Resolve" },
            ...
            { id: "ar5", num: "INC009440", subject: "Deterministic (API Integration) — OAuth Token Exchange Timeout Issue", system: "API Gateway & Auth Service", resolution: "Automated Key Rotation & OAuth Cache Flush", status: "Action Required", statusType: "warn", isDeterministic: true, actionLabel: "Auto Resolve" },
            { id: "ar6", num: "INC009452", subject: "Deterministic (Application Issue) — Member Profile Session State Mismatch", system: "Member Portal Session Service", resolution: "Deterministic Session Cache Re-sync", status: "Action Required", statusType: "warn", isDeterministic: true, actionLabel: "Auto Resolve" },
          ],
        },
        vulnerabilities: {
